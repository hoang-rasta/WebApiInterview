...
HTTP Methods (hay còn gọi là HTTP Verbs) là các phương thức xác định hành động mà client muốn thực hiện đối với tài nguyên trên máy chủ. Mỗi HTTP Request phải có một HTTP Method, giúp server hiểu được mục đích của yêu cầu.
